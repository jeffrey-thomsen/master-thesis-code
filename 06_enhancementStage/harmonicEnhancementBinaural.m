...
% sigmaDesired, deltaDesired, cfrDesired - structs containing Sigma, Delta
% and CFR values of detected periodic subband samples of left and right 
% channel
...
function [enhancedSubbandSignalArray, targetSampleIndices, ...
  ...
  cfrDesired, p0DetectedIndexVectors, AlgorithmParameters)
    ...
    for iBand = 1:nBands
        ...
        [subbandSignalArray.R, targetSampleIndices.R{iBand}, ...
            ...
            p0DetectedIndexVectors.R, azimuthDegCells, cfrDesired.R, ...
