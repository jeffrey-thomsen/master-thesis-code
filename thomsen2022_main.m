...
precisionTarget = nTotalTruePositivesT / ...
    (nTotalTruePositivesT + nTotalFalsePositivesT);
precisionInterf = nTotalTruePositivesI / ...
    (nTotalTruePositivesI + nTotalFalsePositivesI);
recallTarget = nTotalTruePositivesT / ...
    (nTotalTruePositivesT + nTotalFalseNegativesT);
recallInterf = nTotalTruePositivesI / ...
    (nTotalTruePositivesI + nTotalFalseNegativesI);

precisionTotal = (nTotalTruePositivesT+nTotalTruePositivesI) / ...
...
legend('Target speech signal', 'Interferer speech signal', 'Mixed speech signal')
...
function Metric = plotDistanceMetric(dataMixedSeparateSampleIndices, dataSeparateSeparateSampleIndices, ...
    ...
    p0SearchRangeSamplesVector, nBands, centerFreqsHz, separateString, lengthOfSignal, Plotting)
